...
class TestRomanToDecimal(unittest.TestCase):
    ...
    def test_91(self):
        resultado = roman_to_decimal('XCI')
        self.assertEqual(resultado, 91)
    def test_C(self):
        resultado = roman_to_decimal('C')
        self.assertEqual(resultado, 100)
    def test_484(self):
        resultado = roman_to_decimal('CDLXXXIV')
        self.assertEqual(resultado, 484)
    def test_D(self):
        resultado = roman_to_decimal('D')
        self.assertEqual(resultado, 500)
    def test_827(self):
        resultado = roman_to_decimal('DCCCXXVII')
        self.assertEqual(resultado, 827)    
    def test_M(self):
